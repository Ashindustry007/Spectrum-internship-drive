...
#Below is the code for selecting the optimum no. of features from top of largest score to predict most accurately through iteation.
'''
for i in range(1,41):
    sortdf=featureScores.nsmallest(i,'Score')
    xx=x.drop(list(sortdf.Specs),axis=1)
